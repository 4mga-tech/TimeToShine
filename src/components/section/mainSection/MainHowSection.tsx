    ...
    <>
      <div className="sect-main flat-animate-tab">
        <div className="s-img_item wow bounceInScale">
          <Image
            src="/assets/images/section/gradient-ring-bg.webp"
            alt="Background"
            width={860}
            height={400}
          />
        ...
        <div className="container">
          ...
          <div className="row">
            ...
            <div className="col-md-6 offset-xl-2 col-xl-4">
              <ul
                className="tab-how_to position-relative mx-1 wow fadeInUp"
                role="tablist"
              >
                {stepItems.map((item, index) => (
                  <Fragment key={item.id}>
                    <li className="nav-tab-item" role="presentation">
                      <div
                        className={classNames("btn_tab", {
                          active: activeTab === item.id,
                        })}
                        role="tab"
                        onClick={() => setActiveTab(item.id)}
                      >
                        <p className="number-item text-caption font-2">
                          {item.number}
                        </p>
                    ...
                    {index < stepItems.length - 1 && (
                      <div className="br-line has-dot" aria-hidden="true" />
                    )}
                  </Fragment>
                ))}
              </ul>
