            ...
            <div className="place-video pt-0">
              ...
              <div className="sect-title wow fadeInUp">
                <h2 className="s-title font-3">
                  Технологийн хөгжил дэвшил <br />
                  Бидний хөдлөх хүч
                </h2>
                <p className="s-sub_title">
                  Орчин үеийн дэвшилтэт технологид суурилсан найдвартай, шинэлэг
                  шийдлийг бүтээж, байгууллага, хэрэглэгчдийн хэрэгцээг ханган{" "}
                  <br className="d-none d-lg-block" /> , үйл ажиллагааг нь
                  хялбаршуулахын зэрэгцээ үр ашиг, бүтээмж, тогтвортой хөгжлийг
                  дэмжих.
                </p>
              </div>
            </div>
                  ...
                  <div className="box-icon-text wow fadeInUp" key={idx}>
                    <div className="icon">
                      <Image
                        width={78}
                        height={78}
                        src={`/assets/images/section/${item.image_icon}`}
                        alt="Icon"
                      />
                    </div>
