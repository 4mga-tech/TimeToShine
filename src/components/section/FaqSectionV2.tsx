        ...
        <div className="container">
          ...
          <div className="row">
            <div className="col-lg-10 col-xl-8 mx-auto">
              <div
                className="faq-accordion-list px-16 px-xl-0"
                id="frequently-ask"
              >
                {faqItems2.map((item, index) => (
                  <div
                    key={index}
                    className={`faq-accordion_item ${activeIndex === index ? "active" : ""}`}
                  >
                    <div className="img-item-1">
                      <Image
                        ...
                        width={600}
                        height={152}
                        src="/assets/images/item/item-bg-2.png"
                        alt="Image"
                      />
                    </div>
                    <div
                    ...
                    >
                      <span className="text fw-medium h5 font-3">
                        {item.title}
                      </span>
                      <span className="icon ic-accordion-custom"></span>
                    </div>
                    <div
                      className={`collapse-ani ${activeIndex === index ? "show" : ""}`}
                    >
